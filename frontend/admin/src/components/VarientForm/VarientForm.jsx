...
function VarientForm({ api, method, title, btnName, proId, id }) {
  ...
  const handleImageChange = (setImage, setImgPre) => {

    setImgError(false)


    setEditor(<EditImage setImage={setImage} setImgPre={setImgPre} id={id} setOldImage={setOldImage} setEditor={setEditor} />)
                      ...
                      <div className='col-3 text-center'>
                        <div className="mb-4 d-flex justify-content-center">
                          <div>
                            ...
                            <img id="selectedImage1" src={imagePre1 ? imagePre1 : img} style={{ width: "100%", height: "150px" }} onClick={() => {
                              handleImageChange(setImage1, setImagePre1)
                            }} />
                      ...
                      <div className='col-3'>
                        <div className="mb-4 d-flex justify-content-center">
                          <div>
                            ...
                            <img id="selectedImage" src={imagePre2 ? imagePre2 : img} style={{ width: "100%", height: "150px" }} onClick={() => {
                              handleImageChange(setImage2, setImagePre2)
                            }} />
                      ...
                      <div className='col-3'>
                        <div className="mb-4 d-flex justify-content-center">
                          <div>
                            ...
                            <img id="selectedImage" src={imagePre3 ? imagePre3 : img} style={{ width: "100%", height: "150px" }} onClick={() => {
                              handleImageChange(setImage3, setImagePre3)
                            }} />
                      ...
                      <div className='col-3'>
                        <div className="mb-4 d-flex justify-content-center">
                          <div>
                            ...
                            <img id="selectedImage" src={imagePre4 ? imagePre4 : img} alt="example placeholder" style={{ width: "100%", height: "150px" }} onClick={() => {
                              handleImageChange(setImage4, setImagePre4)
                            }} />
